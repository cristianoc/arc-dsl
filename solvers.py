...
def solve_c1d99e64(I):
    x1 = frontiers(I)
    x2 = merge(cast_ContainerContainer(x1))
    O = fill(I, TWO, cast_Patch(x2))
    return O

def solve_b91ae062(I):
    x1 = numcolors(I)
    x2 = decrement(cast_Integer(x1))
    O = upscale(I, x2)
    return O

def solve_3aa6fb7a(I):
    x1 = objects(I, T, F, T)
    x2 = mapply(corners, cast_ContainerContainer(x1))
    O = underfill(I, ONE, cast_Patch(x2))
    return O

def solve_7b7f7511(I):
    x1 = portrait(I)
    x2 = branch(x1, tophalf, lefthalf)
    O = cast_Callable(x2)(I)
    return O

def solve_4258a5f9(I):
    x1 = ofcolor(I, FIVE)
    x2 = mapply(neighbors, cast_ContainerContainer(x1))
    O = fill(I, ONE, cast_Patch(x2))
    return O
...
def solve_2dc579da(I):
    ...
    O = argmax(cast_Container(x3), numcolors)
    return O
...
def solve_42a50994(I):
    ...
    x3 = merge(cast_ContainerContainer(x2))
    O = cover(I, cast_Patch(x3))
    return O
...
def solve_3618c87e(I):
    ...
    x2 = sizefilter(x1, ONE)
    x3 = merge(cast_ContainerContainer(x2))
    O = move(I, cast_Object(x3), TWO_BY_ZERO)
    return O
...
def solve_41e4d17e(I):
    ...
    x4 = mapply(x3, cast_ContainerContainer(x1))
    O = underfill(I, SIX, cast_Patch(x4))
    return O
...
def solve_aedd82e4(I):
    ...
    x4 = merge(cast_ContainerContainer(x3))
    O = fill(I, ONE, cast_Patch(x4))
    return O
...
def solve_bb43febb(I):
    ...
    x4 = mapply(x3, cast_ContainerContainer(x2))
    O = fill(I, TWO, cast_Patch(x4))
    return O
...
def solve_0ca9ddb6(I):
    ...
    x5 = fill(I, SEVEN, cast_Patch(x3))
    O = fill(x5, FOUR, cast_Patch(x4))
    return O
...
def solve_543a7ed5(I):
    ...
    x3 = mapply(outbox, cast_ContainerContainer(x2))
    x4 = fill(I, THREE, cast_Patch(x3))
    x5 = mapply(delta, cast_ContainerContainer(x2))
    O = fill(x4, FOUR, cast_Patch(x5))
    return O
...
def solve_b60334d2(I):
    ...
    x5 = fill(x2, ONE, cast_Patch(x3))
    O = fill(x5, FIVE, cast_Patch(x4))
    return O
...
def solve_d037b0a7(I):
    ...
    x5 = mapply(x4, cast_ContainerContainer(x1))
    O = paint(I, cast_Object(x5))
    return O
...
def solve_e3497940(I):
    ...
    x3 = vmirror(x2)
    x4 = objects(x3, T, F, T)
    x5 = merge(cast_ContainerContainer(x4))
    O = paint(x1, cast_Object(x5))
    return O
...
def solve_d406998b(I):
    ...
    x4 = sfilter(x2, x3)
    x5 = fill(x1, THREE, cast_Patch(x4))
    O = vmirror(x5)
    return O
...
def solve_3906de3d(I):
    ...
    x4 = apply(x2, x3)
    x5 = switch(cast_Grid(x4), ONE, TWO)
    O = cmirror(x5)
    return O
...
def solve_10fcaaa3(I):
    ...
    O = underfill(x3, EIGHT, cast_Patch(x5))
    return O
...
def solve_90c28cc7(I):
    ...
    x2 = first(x1)
    x3 = subgrid(x2, I)
    x4 = dedupe(cast_Tuple(x3))
    x5 = rot90(cast_Grid(x4))
    x6 = dedupe(cast_Tuple(x5))
    O = rot270(cast_Grid(x6))
    return O
...
def solve_b6afb2da(I):
    ...
    x4 = mapply(box, cast_ContainerContainer(x3))
    x5 = fill(x2, FOUR, cast_Patch(x4))
    x6 = mapply(corners, cast_ContainerContainer(x3))
    O = fill(x5, ONE, cast_Patch(x6))
    return O
...
def solve_dbc1a6ce(I):
    ...
    x4 = apply(x3, cast_Container(x2))
    x5 = fork(either, vline, hline)
    x6 = mfilter(x4, x5)
    O = underfill(I, EIGHT, cast_Patch(x6))
    return O
...
def solve_40853293(I):
    ...
    x4 = mfilter(x3, hline)
    x5 = mfilter(x3, vline)
    x6 = paint(I, cast_Object(x4))
    O = paint(x6, cast_Object(x5))
    return O

def solve_5521c0d9(I):
    x1 = objects(I, T, F, T)
    x2 = merge(cast_ContainerContainer(x1))
    x3 = cover(I, cast_Patch(x2))
    x4 = chain(toivec, invert, height)
    x5 = fork(shift, identity, x4)
    x6 = mapply(x5, cast_ContainerContainer(x1))
    O = paint(x3, cast_Object(x6))
    return O
...
def solve_f8ff0b80(I):
    ...
    x5 = apply(x4, x3)
    x6 = merge(cast_ContainerContainer(x5))
    O = hmirror(cast_Grid(x6))
    return O
...
def solve_85c4e7cd(I):
    ...
    x4 = order(x1, x2)
    x5 = apply(color, x4)
    x6 = mpapply(recolor, cast_Tuple(x5), x3)
    O = paint(I, cast_Object(x6))
    return O
...
def solve_d2abd087(I):
    ...
    x4 = mfilter(x1, x2)
    x5 = mfilter(x1, x3)
    x6 = fill(I, TWO, cast_Patch(x4))
    O = fill(x6, ONE, cast_Patch(x5))
    return O
...
def solve_e9614598(I):
    ...
    x3 = cast_Callable(x2)(x1)
    x4 = halve(x3)
    x5 = dneighbors(x4)
    x6 = insert(x4, x5)
    O = fill(I, THREE, cast_Patch(x6))
    return O
...
def solve_810b9b61(I):
    ...
    x7 = mfilter(cast_Container(x5), x6)
    O = fill(I, THREE, cast_Patch(x7))
    return O
...
def solve_54d82841(I):
    ...
    x6 = lbind(astuple, x5)
    x7 = apply(x6, x4)
    O = fill(I, FOUR, cast_Patch(x7))
    return O

def solve_60b61512(I):
    x1 = objects(I, T, T, T)
    x2 = mapply(delta, cast_ContainerContainer(x1))
    O = fill(I, SEVEN, cast_Patch(x2))
    return O
...
def solve_25d8a9c8(I):
    ...
    x4 = mfilter(cast_Container(x3), hline)
    x5 = toindices(cast_Patch(x4))
    x6 = difference(x1, x5)
    x7 = fill(I, FIVE, x5)
    O = fill(x7, ZERO, cast_Patch(x6))
    return O
...
def solve_fcb5c309(I):
    ...
    x3 = colorfilter(x2, x1)
    x4 = difference(x2, x3)
    x5 = argmax(cast_Container(x4), size)
    x6 = color(x5)
    x7 = subgrid(x5, I)
    O = replace(x7, x6, x1)
    return O
...
def solve_e8593010(I):
    ...
    x4 = merge(cast_ContainerContainer(x2))
    x5 = fill(I, THREE, cast_Patch(x4))
    x6 = merge(cast_ContainerContainer(x3))
    x7 = fill(x5, TWO, cast_Patch(x6))
...
def solve_1190e5a7(I):
    ...
    x3 = sfilter(x2, vline)
    x4 = difference(x2, x3)
    x5 = astuple(cast_Integer(x4), cast_Integer(x3))
    x6 = apply(size, cast_Container(x5))
    x7 = increment(cast_Integer(x6))
    O = canvas(x1, x7)
    return O
...
def solve_fcc82909(I):
    ...
    x7 = compose(box, x6)
    x8 = mapply(x7, cast_ContainerContainer(x1))
    O = fill(I, THREE, cast_Patch(x8))
    return O
...
def solve_72ca375d(I):
    ...
    x4 = apply(x3, x2)
    x5 = apply(vmirror, x4)
    x6 = papply(equality, cast_Tuple(x4), cast_Tuple(x5))
    x7 = pair(cast_Tuple(x4), x6)
    x8 = extract(x7, last)
    O = first(x8)
    return O
...
def solve_253bf280(I):
    ...
    x4 = compose(x3, size)
    x5 = sfilter(cast_Container(x2), x4)
    x6 = fork(either, vline, hline)
    x7 = mfilter(x5, x6)
    x8 = fill(I, THREE, cast_Patch(x7))
    O = fill(x8, EIGHT, x1)
    return O
...
def solve_694f12f3(I):
    ...
    x4 = argmin(x2, size)
    x5 = argmax(x2, size)
    x6 = cast_Callable(x3)(x4)
    x7 = cast_Callable(x3)(x5)
    x8 = fill(I, ONE, x6)
    O = fill(x8, TWO, x7)
    return O
...
def solve_73251a56(I):
    x1 = dmirror(I)
    x2 = papply(pair, cast_Tuple(I), cast_Tuple(x1))
    x3 = lbind(apply, maximum)
    x4 = apply(x3, x2)
    x5 = mostcolor(cast_Element(x4))
    x6 = replace(cast_Grid(x4), ZERO, x5)
    x7 = index(x6, ORIGIN)
...
def solve_25d487eb(I):
    ...
    x3 = ofcolor(I, x1)
    x4 = center(x3)
    x5 = merge(cast_ContainerContainer(x2))
    x6 = center(cast_Patch(x5))
    x7 = subtract(x6, x4)
    x8 = shoot(x4, x7)
    O = underfill(I, x1, x8)
    return O
...
def solve_b8825c91(I):
    ...
    x2 = dmirror(x1)
    x3 = papply(pair, cast_Tuple(x1), cast_Tuple(x2))
    x4 = lbind(apply, maximum)
    x5 = apply(x4, x3)
    x6 = cmirror(cast_Grid(x5))
    x7 = papply(pair, cast_Tuple(x5), cast_Tuple(x6))
    x8 = apply(x4, x7)
    O = cmirror(cast_Grid(x8))
    return O
...
def solve_6e82a1ae(I):
    ...
    x3 = compose(merge, x2)
    x4 = cast_Callable(x3)(TWO)
    x5 = cast_Callable(x3)(THREE)
    x6 = cast_Callable(x3)(FOUR)
    x7 = fill(I, THREE, x4)
    x8 = fill(x7, TWO, x5)
    O = fill(x8, ONE, x6)
    return O
...
def solve_868de0fa(I):
    ...
    x4 = sfilter(x2, x3)
    x5 = difference(x2, x4)
    x6 = merge(cast_ContainerContainer(x4))
    x7 = merge(cast_ContainerContainer(x5))
    x8 = fill(I, TWO, cast_Patch(x6))
    O = fill(x8, SEVEN, cast_Patch(x7))
    return O
...
def solve_8e5a5113(I):
    ...
    x2 = rot90(x1)
    x3 = rot180(x1)
    x4 = astuple(cast_Integer(x2), cast_Integer(x3))
    x5 = astuple(FOUR, EIGHT)
    x6 = apply(tojvec, cast_Container(x5))
    x7 = apply(asobject, cast_Container(x4))
    x8 = mpapply(shift, cast_Tuple(x7), cast_Tuple(x6))
    O = paint(I, cast_Object(x8))
    return O
...
def solve_025d127b(I):
    x1 = objects(I, T, F, T)
    x2 = apply(color, x1)
    x3 = merge(cast_ContainerContainer(x1))
...
def solve_2281f1f4(I):
    ...
    x6 = apply(x5, cast_Container(x2))
    x7 = urcorner(x1)
    x8 = remove(x7, x6)
    O = underfill(I, TWO, cast_Patch(x8))
    return O
...
def solve_d4f3cd78(I):
    ...
    x4 = box(x1)
    x5 = difference(x4, x1)
    x6 = position(x4, cast_Patch(x5))
    x7 = first(cast_Container(x5))
    x8 = shoot(x7, x6)
    O = fill(x3, EIGHT, x8)
    return O
...
def solve_bda2d7a6(I):
    ...
    x6 = repeat(x4, ONE)
    x7 = combine(x6, x5)
    x8 = mpapply(recolor, cast_Tuple(x3), cast_Tuple(x7))
    O = paint(I, cast_Object(x8))
    return O
...
def solve_137eaa0f(I):
    ...
    x7 = mapply(x5, cast_ContainerContainer(x1))
    x8 = shift(cast_Patch(x7), UNITY)
    O = paint(x6, x8)
    return O
...
def solve_b8cdaf2b(I):
    ...
    x8 = combine(x6, x7)
    O = underfill(I, x1, cast_Patch(x8))
    return O
...
def solve_bd4472b8(I):
    ...
    x6 = hupscale(x5, x1)
    x7 = repeat(x6, TWO)
    x8 = merge(cast_ContainerContainer(x7))
    O = vconcat(x3, cast_Grid(x8))
    return O
...
def solve_4be741c5(I):
    ...
    x4 = cast_Callable(x3)(I)
    x5 = astuple(ONE, x4)
    x6 = cast_Callable(x2)(I)
    x7 = crop(x6, ORIGIN, x5)
    x8 = apply(dedupe, x7)
    O = cast_Callable(x2)(x8)
    return O
...
def solve_d90796e8(I):
    ...
    x5 = mfilter(cast_Container(x2), x4)
    x6 = cover(I, cast_Patch(x5))
    x7 = matcher(first, THREE)
    x8 = sfilter(cast_Container(x5), x7)
    O = fill(x6, EIGHT, cast_Patch(x8))
    return O
...
def solve_2c608aff(I):
    ...
    x8 = mfilter(cast_Container(x6), x7)
    O = underfill(I, x1, cast_Patch(x8))
    return O
...
def solve_f8b3ba0a(I):
    ...
    x8 = apply(x7, x6)
    x9 = merge(cast_ContainerContainer(x8))
    O = crop(cast_Grid(x9), DOWN, x2)
    return O
...
def solve_83302e8f(I):
    ...
    x4 = difference(x2, x3)
    x5 = merge(cast_ContainerContainer(x3))
    x6 = recolor(THREE, cast_Patch(x5))
    x7 = merge(cast_ContainerContainer(x4))
    x8 = recolor(FOUR, cast_Patch(x7))
    x9 = paint(I, x6)
    O = paint(x9, x8)
    return O
...
def solve_11852cab(I):
    x1 = objects(I, T, T, T)
    x2 = merge(cast_ContainerContainer(x1))
    x3 = hmirror(cast_Grid(x2))
    x4 = vmirror(cast_Grid(x2))
    x5 = dmirror(cast_Grid(x2))
    x6 = cmirror(cast_Grid(x2))
    x7 = paint(I, x3)
    x8 = paint(x7, x4)
    x9 = paint(x8, x5)
    O = paint(x9, x6)
...
def solve_3de23699(I):
    ...
    x3 = first(cast_Container(x2))
    x4 = difference(x1, x2)
    x5 = first(cast_Container(x4))
    x6 = color(x3)
    x7 = color(x5)
    x8 = subgrid(x3, I)
    x9 = trim(x8)
...
def solve_623ea044(I):
    ...
    x3 = center(x2)
    x4 = color(x2)
    x5 = astuple(cast_Integer(UNITY), cast_Integer(NEG_UNITY))
...
def solve_88a62173(I):
    ...
    x5 = bottomhalf(x1)
    x6 = bottomhalf(x2)
    x7 = astuple(cast_Integer(x3), cast_Integer(x4))
    x8 = astuple(cast_Integer(x5), cast_Integer(x6))
    x9 = combine(cast_Container(x7), cast_Container(x8))
    O = leastcommon(x9)
    return O
...
def solve_af902bf9(I):
    ...
    x2 = prapply(connect, x1, x1)
    x3 = fork(either, vline, hline)
    x4 = mfilter(cast_Container(x2), x3)
    x5 = underfill(I, NEG_ONE, cast_Patch(x4))
    x6 = objects(x5, F, F, T)
    x7 = compose(backdrop, inbox)
    x8 = mapply(x7, cast_ContainerContainer(x6))
    x9 = fill(x5, TWO, cast_Patch(x8))
...
def solve_b548a754(I):
    ...
    x5 = leastcolor(x4)
    x6 = merge(cast_ContainerContainer(x1))
    x7 = backdrop(cast_Patch(x6))
    x8 = box(cast_Patch(x6))
    x9 = fill(I, x3, x7)
    O = fill(x9, x5, x8)
    return O
...
def solve_a3325580(I):
    ...
    x2 = valmax(x1, size)
    x3 = sizefilter(x1, x2)
    x4 = order(cast_Container(x3), leftmost)
    x5 = apply(color, x4)
    x6 = astuple(ONE, x2)
    x7 = rbind(canvas, x6)
    x8 = apply(x7, x5)
    x9 = merge(cast_ContainerContainer(x8))
    O = dmirror(cast_Grid(x9))
    return O
...
def solve_1caeab9d(I):
    ...
    x7 = merge(cast_ContainerContainer(x1))
    x8 = cover(I, cast_Patch(x7))
    x9 = mapply(x6, cast_ContainerContainer(x1))
    O = paint(x8, cast_Object(x9))
    return O
...
def solve_c0f76784(I):
    ...
    x5 = merge(cast_ContainerContainer(x4))
    x6 = argmax(x3, size)
    x7 = merge(cast_ContainerContainer(x3))
    x8 = fill(I, SEVEN, cast_Patch(x7))
    x9 = fill(x8, EIGHT, x6)
    O = fill(x9, SIX, cast_Patch(x5))
    return O
...
def solve_ddf7fa4f(I):
    ...
    x2 = sizefilter(x1, ONE)
    x3 = colorfilter(x1, FIVE)
    x4 = product(cast_Container(x2), x3)
    x5 = fork(vmatching, first, last)
    x6 = sfilter(cast_Container(x4), x5)
...
def solve_6c434453(I):
    ...
    x5 = merge(cast_ContainerContainer(x2))
    x6 = cover(I, cast_Patch(x5))
    x7 = apply(ulcorner, cast_Container(x2))
    x8 = lbind(shift, x4)
    x9 = mapply(x8, cast_ContainerContainer(x7))
...
def solve_c8cbb738(I):
    ...
    x2 = fgpartition(I)
    x3 = valmax(x2, shape)
    x4 = canvas(x1, cast_IntegerTuple(x3))
...
def solve_3eda0437(I):
    ...
    x8 = mapply(x7, cast_ContainerContainer(x2))
    x9 = argmax(cast_Container(x8), size)
    O = fill(I, SIX, x9)
    return O
...
def solve_dc0a314f(I):
    ...
    x3 = dmirror(x2)
    x4 = papply(pair, cast_Tuple(x2), cast_Tuple(x3))
    x5 = lbind(apply, maximum)
    x6 = apply(x5, x4)
    x7 = cmirror(cast_Grid(x6))
    x8 = papply(pair, cast_Tuple(x6), cast_Tuple(x7))
    x9 = apply(x5, x8)
    O = subgrid(x1, cast_Grid(x9))
    return O
...
def solve_c444b776(I):
    ...
    x9 = mapply(x8, cast_ContainerContainer(x2))
    O = paint(I, cast_Object(x9))
    return O
...
def solve_d4a91cb9(I):
    ...
    x9 = connect(x7, x4)
    x10 = combine(x8, x9)
    O = underfill(I, FOUR, cast_Patch(x10))
    return O
...
def solve_ff28f65a(I):
    ...
    x6 = astuple(ONE, NINE)
    x7 = canvas(ZERO, x6)
    x8 = fill(x7, ONE, cast_Patch(x5))
    x9 = hsplit(x8, THREE)
    O = cast_Grid(merge(cast_ContainerContainer(x9)))
    return O
...
def solve_a85d4709(I):
    ...
    x5 = chain(x4, x3, x2)
    x6 = cast_Callable(x5)(ZERO)
    x7 = cast_Callable(x5)(TWO)
    x8 = cast_Callable(x5)(ONE)
    x9 = fill(I, TWO, x6)
...
def solve_feca6190(I):
    ...
    x8 = fork(recolor, color, x7)
    x9 = mapply(x8, cast_ContainerContainer(x1))
    x10 = paint(x5, cast_Object(x9))
    O = hmirror(x10)
    return O
...
def solve_beb8660c(I):
    ...
    x8 = apply(toivec, x7)
    x9 = mpapply(shift, cast_Tuple(x5), cast_Tuple(x8))
    x10 = canvas(ZERO, x1)
    x11 = paint(x10, cast_Object(x9))
    O = rot180(x11)
    return O
...
def solve_913fb3ed(I):
    ...
    x7 = fill(I, SIX, cast_Patch(x4))
    x8 = fill(x7, FOUR, cast_Patch(x5))
    O = fill(x8, ONE, cast_Patch(x6))
    return O
...
def solve_0962bcdd(I):
    ...
    x6 = fill(I, x3, cast_Patch(x5))
    x7 = objects(x6, F, T, T)
    x8 = fork(connect, ulcorner, lrcorner)
    x9 = fork(connect, llcorner, urcorner)
    x10 = fork(combine, x8, x9)
    x11 = mapply(x10, cast_ContainerContainer(x7))
    O = fill(x6, x1, cast_Patch(x11))
    return O
...
def solve_3631a71a(I):
    ...
    x3 = lbind(apply, maximum)
    x4 = dmirror(x2)
    x5 = papply(pair, cast_Tuple(x2), cast_Tuple(x4))
    x6 = apply(x3, x5)
    x7 = subtract(x1, TWO_BY_TWO)
    x8 = crop(cast_Grid(x6), TWO_BY_TWO, x7)
    x9 = vmirror(x8)
    x10 = objects(x9, T, F, T)
    x11 = merge(cast_ContainerContainer(x10))
    x12 = shift(cast_Patch(x11), TWO_BY_TWO)
    O = paint(cast_Grid(x6), x12)
    return O
...
def solve_95990924(I):
    ...
    x7 = fill(I, ONE, cast_Patch(x3))
    x8 = fill(x7, TWO, cast_Patch(x4))
    x9 = fill(x8, THREE, cast_Patch(x5))
    O = fill(x9, FOUR, cast_Patch(x6))
    return O
...
def solve_e509e548(I):
    ...
    x12 = fill(x11, TWO, cast_Patch(x9))
    O = fill(x12, ONE, cast_Patch(x10))
    return O
...
def solve_d43fd935(I):
    ...
    x7 = sfilter(cast_Container(x3), x6)
...
def solve_db3e9e38(I):
    ...
    x11 = fill(I, EIGHT, cast_Patch(x7))
    x12 = sfilter(cast_Container(x7), x10)
    O = fill(x11, SEVEN, cast_Patch(x12))
    return O
...
def solve_97999447(I):
    ...
    x5 = fork(recolor, color, x4)
    x6 = mapply(x5, cast_ContainerContainer(x1))
    x7 = paint(I, cast_Object(x6))
    x8 = interval(ZERO, FIVE, ONE)
    x9 = apply(double, x8)
    x10 = apply(increment, x9)
    x11 = apply(tojvec, x10)
    x12 = prapply(shift, x2, x11)
    x13 = merge(cast_ContainerContainer(x12))
    O = fill(x7, FIVE, cast_Patch(x13))
    return O
...
def solve_a61ba2ce(I):
    ...
    x6 = lbind(compose, x3)
    x7 = chain(x5, x4, x6)
    x8 = cast_Callable(x7)(ulcorner)
    x9 = cast_Callable(x7)(urcorner)
    x10 = cast_Callable(x7)(llcorner)
    x11 = cast_Callable(x7)(lrcorner)
    x12 = hconcat(x11, x10)
    x13 = hconcat(x9, x8)
    O = vconcat(x12, x13)
    return O
...
def solve_8e1813be(I):
    ...
    x6 = cast_Callable(x5)(x1)
    x7 = objects(x6, T, T, T)
    x8 = order(x7, uppermost)
    x9 = apply(color, x8)
    x10 = dedupe(cast_Tuple(x9))
    x11 = size(x10)
    x12 = rbind(repeat, x11)
    x13 = apply(x12, x10)
    O = cast_Callable(x5)(x13)
    return O
...
def solve_5c2c9af4(I):
    ...
    x10 = apply(x9, x7)
    x11 = apply(x9, x8)
    x12 = pair(cast_Tuple(x10), cast_Tuple(x11))
    x13 = mapply(box, cast_ContainerContainer(x12))
    x14 = shift(cast_Patch(x13), x3)
    O = fill(I, x1, x14)
    return O
...
def solve_75b8110e(I):
    ...
    x10 = cast_Callable(x9)(x5)
    x11 = cast_Callable(x9)(x4)
    x12 = cast_Callable(x9)(x6)
    x13 = paint(x3, x12)
    x14 = paint(x13, x11)
    O = paint(x14, x10)
    return O
...
def solve_941d9a10(I):
    ...
    x10 = cast_Callable(x7)(ORIGIN)
    x11 = cast_Callable(x7)(x8)
    x12 = cast_Callable(x7)(x9)
    x13 = fill(I, ONE, x10)
...
def solve_c3f564a4(I):
    ...
    x2 = dmirror(I)
    x3 = invert(NINE)
    x4 = papply(pair, cast_Tuple(I), cast_Tuple(x2))
    x5 = lbind(apply, maximum)
    x6 = apply(x5, x4)
    x7 = ofcolor(cast_Grid(x6), ZERO)
    x8 = difference(x1, x7)
    x9 = toobject(cast_Patch(x8), cast_Grid(x6))
    x10 = interval(x3, NINE, ONE)
    x11 = interval(NINE, x3, NEG_ONE)
    x12 = pair(x10, x11)
    x13 = lbind(shift, x9)
    x14 = mapply(x13, cast_ContainerContainer(x12))
    O = paint(cast_Grid(x6), cast_Object(x14))
    return O
...
def solve_1a07d186(I):
    ...
    x2 = sizefilter(x1, ONE)
    x3 = difference(x1, x2)
    x4 = apply(color, cast_Container(x3))
    x5 = rbind(contained, x4)
    x6 = compose(x5, color)
    x7 = sfilter(cast_Container(x2), x6)
...
def solve_9af7a82c(I):
    ...
    x13 = apply(x12, x2)
    x14 = merge(cast_ContainerContainer(x13))
    O = cmirror(cast_Grid(x14))
    return O
...
def solve_6e19193c(I):
    ...
    x12 = mapply(x11, cast_ContainerContainer(x2))
    x13 = fill(I, x1, cast_Patch(x12))
    x14 = mapply(delta, cast_ContainerContainer(x2))
    O = fill(x13, ZERO, cast_Patch(x14))
    return O
...
def solve_cbded52d(I):
    x1 = objects(I, T, F, T)
    x2 = sizefilter(x1, ONE)
    x3 = product(cast_Container(x2), cast_Container(x2))
...
def solve_8a004b2b(I):
    ...
    x7 = objects(x6, T, F, T)
    x8 = merge(cast_ContainerContainer(x7))
    x9 = width(cast_Patch(x8))
    x10 = ulcorner(cast_Patch(x8))
    x11 = width(x4)
    x12 = divide(x9, x11)
    x13 = upscale(x5, x12)
    x14 = shift(x13, x10)
...
def solve_e26a3af2(I):
    ...
    x7 = cast_Callable(x6)(x2)
    x8 = cast_Callable(x6)(x3)
    x9 = greater(x8, x7)
    x10 = branch(x9, height, width)
    x11 = cast_Callable(x10)(I)
    x12 = rot90(cast_Grid(x4))
    x13 = branch(x9, x5, x12)
    x14 = branch(x9, vupscale, hupscale)
    O = cast_Callable(x14)(x13, x11)
    return O

def solve_6cf79266(I):
    x1 = ofcolor(I, ZERO)
    x2 = astuple(ZERO, cast_Integer(ORIGIN))
    x3 = initset(x2)
    x4 = upscale(cast_Element(x3), THREE)
    x5 = toindices(x4)
    x6 = lbind(shift, x5)
...
def solve_a87f7484(I):
    ...
    x5 = cast_Callable(m4)(I)
    x6 = decrement(cast_Integer(x1))
    x7 = hsplit(x5, x6)
...
def solve_4093f84a(I):
    ...
    x11 = apply(x9, x7)
    x12 = apply(x10, x8)
    x13 = hconcat(cast_Grid(x11), cast_Grid(x12))
    O = cast_Callable(m5)(x13)
    return O
...
def solve_4612dd53(I):
    ...
    x8 = size(cast_Container(x6))
    x9 = size(cast_Container(x7))
    x10 = greater(x8, x9)
...
def solve_29c11459(I):
    ...
    x7 = mapply(x6, cast_ContainerContainer(x4))
    x8 = paint(x1, cast_Object(x7))
    x9 = mapply(x6, cast_ContainerContainer(x3))
    x10 = paint(I, cast_Object(x9))
    x11 = objects(x8, T, F, T)
    x12 = apply(urcorner, x11)
    x13 = shift(cast_Patch(x12), RIGHT)
    x14 = merge(cast_ContainerContainer(x11))
    x15 = paint(x10, cast_Object(x14))
    O = fill(x15, FIVE, x13)
    return O
...
def solve_ae3edfdc(I):
    ...
    x7 = cast_Callable(x6)(TWO)
    x8 = cast_Callable(x6)(ONE)
    x9 = cast_Callable(x4)(THREE)
    x10 = cast_Callable(x4)(SEVEN)
    x11 = fork(shift, identity, x7)
    x12 = fork(shift, identity, x8)
    x13 = mapply(x11, x9)
    x14 = mapply(x12, x10)
    x15 = paint(x3, cast_Object(x13))
    O = paint(x15, cast_Object(x14))
    return O
...
def solve_1f0c79e5(I):
    ...
    x4 = ofcolor(x2, x3)
    x5 = combine(x1, x4)
    x6 = recolor(x3, cast_Patch(x5))
    x7 = compose(decrement, double)
    x8 = ulcorner(cast_Patch(x5))
    x9 = invert(x8)
    x10 = shift(x1, x9)
    x11 = apply(x7, x10)
...
def solve_6773b310(I):
    ...
    x13 = matcher(x12, TWO)
    x14 = mfilter(x11, x13)
    x15 = fill(x1, ONE, cast_Patch(x14))
...
def solve_780d0b14(I):
    ...
    x7 = apply(color, x6)
    x8 = apply(center, x6)
    x9 = pair(cast_Tuple(x7), cast_Tuple(x8))
    x10 = fill(I, ZERO, x1)
    x11 = paint(x10, cast_Object(x9))
    ...
    x15 = sfilter(x11, x14)
    x16 = rot90(cast_Grid(x15))
    x17 = sfilter(x16, x14)
    O = rot270(cast_Grid(x17))
    return O
...
def solve_2204b7a8(I):
    ...
    x2 = lbind(sfilter, x1)
    x3 = compose(size, x2)
    x4 = cast_Callable(x3)(vline)
    x5 = cast_Callable(x3)(hline)
    x6 = greater(x4, x5)
    x7 = branch(x6, lefthalf, tophalf)
    x8 = branch(x6, righthalf, bottomhalf)
    x9 = branch(x6, hconcat, vconcat)
    x10 = cast_Callable(x7)(I)
    x11 = cast_Callable(x8)(I)
...
def solve_d9f24cd1(I):
    ...
    x4 = mfilter(cast_Container(x3), vline)
    x5 = underfill(I, TWO, cast_Patch(x4))
    x6 = matcher(numcolors, TWO)
    x7 = objects(x5, F, F, T)
    x8 = sfilter(x7, x6)
    x9 = difference(x7, x8)
    x10 = colorfilter(cast_Objects(x9), TWO)
    x11 = mapply(toindices, cast_ContainerContainer(x10))
...
def solve_b782dc8a(I):
    ...
    x11 = mfilter(x9, x10)
    x12 = toindices(cast_Patch(x11))
    x13 = rbind(manhattan, x3)
    x14 = chain(even, x13, initset)
    x15 = sfilter(x12, x14)
    x16 = difference(x12, x15)
    x17 = fill(I, x1, cast_Patch(x15))
    O = fill(x17, x7, cast_Patch(x16))
    return O
...
def solve_673ef223(I):
    ...
    O = underfill(x15, EIGHT, cast_Patch(x17))
    return O
...
def solve_f5b8619d(I):
    ...
    x2 = ofcolor(I, x1)
    x3 = mapply(vfrontier, cast_ContainerContainer(x2))
    x4 = underfill(I, EIGHT, cast_Patch(x3))
    x5 = hconcat(x4, x4)
    O = vconcat(x5, x5)
    return O
...
def solve_f8c80d96(I):
    ...
    x10 = power(x9, TWO)
    x11 = power(x9, THREE)
    x12 = cast_Callable(x9)(x4)
    x13 = cast_Callable(x10)(x4)
    x14 = cast_Callable(x11)(x4)
    x15 = fill(I, x1, x12)
    x16 = fill(x15, x1, x13)
    x17 = fill(x16, x1, x14)
...
def solve_e5062a87(I):
    ...
    x15 = sfilter(x6, x14)
    x16 = merge(cast_ContainerContainer(x15))
    x17 = recolor(TWO, cast_Patch(x16))
    O = paint(I, x17)
    return O

def solve_a8d7556c(I):
    x1 = initset(ORIGIN)
    x2 = recolor(ZERO, cast_Patch(x1))
    x3 = upscale(x2, TWO)
    x4 = occurrences(I, x3)
    x5 = lbind(shift, x3)
    ...
    x13 = add(x9, DOWN)
    x14 = insert(x13, x12)
    x15 = toobject(cast_Patch(x14), x7)
    x16 = toobject(cast_Patch(x14), I)
...
def solve_8403a5d5(I):
    ...
    x16 = apply(x14, x13)
    x17 = fill(I, x4, cast_Patch(x9))
    x18 = fill(x17, FIVE, cast_Patch(x15))
    O = fill(x18, FIVE, cast_Patch(x16))
    return O
...
def solve_5daaa586(I):
    ...
    x13 = mfilter(cast_Container(x12), vline)
    x14 = mfilter(cast_Container(x12), hline)
    x15 = size(cast_Container(x13))
    x16 = size(cast_Container(x14))
    x17 = greater(x15, x16)
...
def solve_3bdb4ada(I):
    ...
    x5 = apply(x3, x2)
    x6 = apply(x4, x2)
    x7 = papply(connect, cast_Tuple(x5), cast_Tuple(x6))
    x8 = apply(last, x5)
    ...
    x17 = pair(x7, cast_Tuple(x8))
    x18 = mapply(x16, cast_ContainerContainer(x17))
    O = fill(I, ZERO, cast_Patch(x18))
    return O
...
def solve_ec883f72(I):
    ...
    x17 = combine(x14, x15)
    x18 = combine(x16, x17)
    O = underfill(I, x7, cast_Patch(x18))
    return O
...
def solve_e8dc4411(I):
    ...
    x12 = shape(x2)
    x13 = multiply(x12, x4)
    x14 = apply(x11, cast_Container(x13))
...
def solve_e40b9e2f(I):
    ...
    x7 = cast_Callable(x6)(x4)
    x8 = lbind(shift, x7)
    x9 = apply(x8, cast_Container(x3))
    x10 = argmax(x9, x5)
    x11 = paint(I, x10)
    ...
    x16 = cast_Callable(x15)(x13)
    x17 = lbind(shift, x16)
    x18 = apply(x17, cast_Container(x3))
    x19 = argmax(x18, x14)
    O = paint(x11, x19)
    return O
...
def solve_29623171(I):
    ...
    x12 = compose(x10, x11)
    x13 = apply(x9, cast_Container(x3))
    x14 = valmax(x13, x12)
    x15 = matcher(x12, x14)
    x16 = compose(flip, x15)
    x17 = mfilter(x13, x15)
    x18 = mfilter(x13, x16)
    x19 = fill(I, x1, cast_Patch(x17))
    O = fill(x19, ZERO, cast_Patch(x18))
    return O
...
def solve_a2fd1cf0(I):
    ...
    x6 = leftmost(x2)
    x7 = astuple(x3, x5)
    x8 = minimum(cast_IntegerSet(x7))
    x9 = maximum(cast_IntegerSet(x7))
    x10 = astuple(x8, x6)
    x11 = astuple(x9, x6)
    x12 = connect(x10, x11)
    x13 = astuple(x4, x6)
    x14 = minimum(cast_IntegerSet(x13))
    x15 = maximum(cast_IntegerSet(x13))
    x16 = astuple(x3, x14)
    x17 = astuple(x3, x15)
    x18 = connect(x16, x17)
    x19 = combine(x12, x18)
    O = underfill(I, EIGHT, cast_Patch(x19))
    return O
...
def solve_8731374e(I):
    ...
    x9 = sfilter(x6, x8)
    x10 = merge(cast_ContainerContainer(x9))
    x11 = rot90(cast_Grid(x10))
    x12 = vsplit(x11, x5)
    x13 = sfilter(x12, x8)
    x14 = merge(cast_ContainerContainer(x13))
    x15 = rot270(cast_Grid(x14))
    x16 = leastcolor(x15)
    x17 = ofcolor(x15, x16)
...
def solve_6cdd2623(I):
    ...
    x8 = box(cast_Patch(x5))
    x9 = rbind(difference, x8)
    x10 = chain(positive, size, x9)
    x11 = fork(both, x7, x10)
    x12 = mfilter(cast_Container(x3), x11)
    O = fill(x6, x1, cast_Patch(x12))
    return O
...
def solve_cdecee7f(I):
    ...
    x7 = apply(x6, x5)
    x8 = merge(cast_ContainerContainer(x7))
    x9 = dmirror(cast_Grid(x8))
    x10 = subtract(NINE, x3)
    x11 = astuple(ONE, x10)
    x12 = canvas(ZERO, x11)
    x13 = hconcat(x9, x12)
    x14 = hsplit(x13, THREE)
    x15 = merge(cast_ContainerContainer(x14))
    x16 = crop(cast_Grid(x15), ORIGIN, x2)
    x17 = crop(cast_Grid(x15), DOWN, x2)
    x18 = crop(cast_Grid(x15), TWO_BY_ZERO, x2)
    x19 = vmirror(x17)
    x20 = vconcat(x16, x19)
    O = vconcat(x20, x18)
    return O
...
def solve_3345333e(I):
    ...
    x8 = vmirror(x5)
    x9 = lbind(shift, x8)
    x10 = apply(x9, cast_Container(x7))
...
def solve_b190f7f5(I):
    ...
    x9 = upscale(x5, x6)
    x10 = cast_Callable(x8)(x4)
    x11 = cast_Callable(x8)(x10)
...
def solve_e21d9049(I):
    ...
    x4 = ofcolor(I, x2)
    x5 = merge(cast_ContainerContainer(x3))
    x6 = shape(cast_Patch(x5))
    x7 = neighbors(ORIGIN)
    x8 = lbind(mapply, neighbors)
    x9 = power(x8, TWO)
    x10 = cast_Callable(x9)(x7)
    ...
    x19 = paint(I, cast_Object(x14))
    x20 = sfilter(x1, x18)
    x21 = difference(x1, x20)
    O = cover(x19, cast_Patch(x21))
    return O
...
def solve_746b3537(I):
    ...
    x2 = cast_Callable(x1)(I)
    x3 = equality(x2, ONE)
    x4 = branch(x3, dmirror, identity)
    x5 = cast_Callable(x4)(I)
    x6 = objects(x5, T, F, F)
    x7 = order(x6, leftmost)
    x8 = apply(color, x7)
    x9 = repeat(x8, ONE)
    O = cast_Callable(x4)(x9)
    return O
...
def solve_63613498(I):
    ...
    x3 = asindices(x1)
    x4 = difference(x3, x2)
    x5 = normalize(cast_Patch(x4))
    x6 = objects(I, T, F, T)
    x7 = compose(toindices, normalize)
    x8 = matcher(x7, x5)
    x9 = mfilter(x6, x8)
    x10 = fill(I, FIVE, cast_Patch(x9))
    x11 = asobject(x1)
    O = paint(x10, x11)
    return O
...
def solve_06df4c85(I):
    ...
    x5 = argmax(x1, size)
    x6 = difference(x1, x4)
    x7 = remove(x5, cast_Container(x6))
    x8 = merge(cast_ContainerContainer(x7))
    x9 = product(x8, x8)
    x10 = power(first, TWO)
    x11 = compose(first, last)
    x12 = fork(equality, x10, x11)
    x13 = sfilter(cast_Container(x9), x12)
...
def solve_f9012d9b(I):
    ...
    x18 = apply(x17, cast_Container(x15))
    x19 = lbind(shift, x5)
...
def solve_4522001f(I):
    ...
    x8 = canvas(ZERO, x7)
    x9 = astuple(THREE, cast_Integer(ORIGIN))
    x10 = initset(x9)
    x11 = upscale(cast_Element(x10), TWO)
    x12 = upscale(x11, TWO)
    x13 = shape(x12)
    x14 = shift(x12, x13)
    x15 = combine(x12, x14)
    x16 = paint(x8, cast_Object(x15))
    x17 = rot90(x16)
    x18 = rot180(x16)
    x19 = rot270(x16)
...
def solve_e179c5f4(I):
    ...
    x19 = merge(cast_ContainerContainer(x18))
    x20 = astuple(x1, x13)
    x21 = crop(cast_Grid(x19), ORIGIN, x20)
    x22 = hmirror(x21)
...
def solve_228f6490(I):
    ...
    x10 = cast_Callable(x9)(x6)
    x11 = cast_Callable(x9)(x7)
    x12 = matcher(x9, x10)
    x13 = matcher(x9, x11)
    x14 = extract(cast_Container(x8), x12)
    x15 = extract(cast_Container(x8), x13)
    x16 = ulcorner(x6)
    x17 = ulcorner(x7)
    x18 = ulcorner(x14)
    x19 = ulcorner(x15)
...
def solve_995c5fa3(I):
    ...
    x20 = compose(x19, x18)
    x21 = apply(x20, x1)
    x22 = merge(cast_ContainerContainer(x21))
    O = hupscale(cast_Grid(x22), THREE)
    return O
...
def solve_36fdfd69(I):
    ...
    x6 = product(x3, x3)
    x7 = sfilter(cast_Container(x6), x5)
    x8 = apply(merge, x7)
    x9 = mapply(delta, cast_ContainerContainer(x8))
    x10 = fill(x1, FOUR, cast_Patch(x9))
    x11 = merge(cast_ContainerContainer(x3))
    x12 = paint(x10, cast_Object(x11))
    O = downscale(x12, TWO)
    return O
...
def solve_0a938d79(I):
    x1 = portrait(I)
    x2 = branch(x1, dmirror, identity)
    x3 = cast_Callable(x2)(I)
    x4 = fgpartition(x3)
    x5 = merge(cast_ContainerContainer(x4))
    x6 = chain(double, decrement, width)
    x7 = cast_Callable(x6)(x5)
    ...
    x15 = mapply(x14, cast_ContainerContainer(x4))
    x16 = paint(x3, cast_Object(x15))
    O = cast_Callable(x2)(x16)
    return O
...
def solve_99fa7670(I):
    ...
    x4 = compose(x3, center)
    x5 = fork(recolor, color, x4)
    x6 = mapply(x5, cast_ContainerContainer(x2))
    x7 = paint(I, cast_Object(x6))
    x8 = add(x1, DOWN_LEFT)
    x9 = initset(x8)
    x10 = recolor(ZERO, cast_Patch(x9))
    x11 = objects(x7, T, F, T)
    x12 = insert(x10, x11)
    x13 = order(cast_Container(x12), uppermost)
    x14 = first(x13)
    x15 = remove(x10, x13)
    x16 = remove(x14, x13)
    ...
    x22 = pair(cast_Tuple(x15), cast_Tuple(x16))
    x23 = mapply(x21, cast_ContainerContainer(x22))
    O = underpaint(x7, cast_Object(x23))
    return O
...
def solve_a78176bb(I):
    ...
    x12 = apply(llcorner, cast_Container(x10))
    ...
    x22 = combine(cast_Container(x20), cast_Container(x21))
...
def solve_952a094c(I):
    ...
    x11 = apply(x10, x5)
    x12 = merge(cast_ContainerContainer(x2))
    x13 = cover(I, cast_Patch(x12))
    O = paint(x13, cast_Object(x11))
    return O
...
def solve_6aa20dc0(I):
    ...
    x19 = compose(x17, x7)
    x20 = product(cast_Container(x15), x10)
    x21 = apply(x16, cast_Container(x20))
    x22 = rapply(x21, x3)
...
def solve_2bcee788(I):
    ...
    x5 = argmin(x2, size)
    x6 = position(x4, x5)
    x7 = first(cast_Container(x6))
    x8 = last(cast_Container(x6))
    x9 = subgrid(x4, x3)
    x10 = hline(x5)
    x11 = hmirror(x9)
    x12 = vmirror(x9)
...
def solve_776ffc46(I):
    ...
    x9 = compose(flip, x8)
    x10 = sfilter(x7, x9)
    x11 = normalize(cast_Patch(x10))
    x12 = toindices(x11)
    x13 = compose(toindices, normalize)
    x14 = matcher(x13, x12)
    x15 = mfilter(x1, x14)
    x16 = color(x11)
    O = fill(I, x16, cast_Patch(x15))
    return O
...
def solve_f35d900a(I):
    ...
    x7 = mapply(x6, cast_ContainerContainer(x1))
    x8 = mapply(toindices, cast_ContainerContainer(x1))
    x9 = box(cast_Patch(x8))
    ...
    x18 = sfilter(cast_Container(x10), x17)
    x19 = paint(I, cast_Object(x7))
    O = fill(x19, FIVE, cast_Patch(x18))
    return O
...
def solve_0dfd9992(I):
    ...
    x23 = apply(x20, cast_Container(x22))
    x24 = lbind(shift, x6)
...
def solve_36d67576(I):
    ...
    x16 = astuple(cast_Integer(cmirror), cast_Integer(dmirror))
    x17 = astuple(cast_Integer(hmirror), cast_Integer(vmirror))
    x18 = combine(cast_Container(x16), cast_Container(x17))
    x19 = product(x18, x18)
    x20 = fork(compose, first, last)
    x21 = apply(x20, cast_Container(x19))
    x22 = totuple(x21)
    x23 = combine(x18, x22)
    x24 = rapply(x23, x2)
...
def solve_469497ad(I):
    ...
    x13 = combine(x10, x11)
    x14 = combine(x12, x13)
    x15 = underfill(x3, TWO, cast_Patch(x14))
    x16 = objects(x15, T, F, T)
...
def solve_484b58aa(I):
    ...
    x10 = cast_Callable(x9)(x1)
    x11 = cast_Callable(x9)(x2)
    x12 = toivec(x11)
    x13 = tojvec(x10)
    x14 = crop(I, x12, x8)
    x15 = crop(I, x13, x7)
    ...
    x24 = apply(x21, cast_Container(x23))
    x25 = lbind(shift, x6)
    x26 = mapply(x25, cast_ContainerContainer(x24))
    O = paint(I, cast_Object(x26))
    return O
...
def solve_3befdf3e(I):
    ...
    x23 = mapply(x15, cast_ContainerContainer(x1))
    x24 = mapply(x22, cast_ContainerContainer(x1))
    x25 = underfill(x6, x5, cast_Patch(x23))
    O = fill(x25, ZERO, cast_Patch(x24))
    return O
...
def solve_9aec4887(I):
    ...
    x16 = apply(x15, x7)
    x17 = paint(x4, cast_Object(x16))
    x18 = fork(connect, ulcorner, lrcorner)
    x19 = cast_Callable(x18)(x7)
    x20 = fork(combine, identity, vmirror)
    x21 = cast_Callable(x20)(x19)
    x22 = intersection(x7, x21)
    O = fill(x17, EIGHT, cast_Patch(x22))
    return O
...
def solve_57aa92db(I):
    ...
    x26 = mapply(x25, cast_ContainerContainer(x14))
    x27 = paint(I, cast_Object(x26))
    x28 = merge(cast_ContainerContainer(x2))
    O = paint(x27, cast_Object(x28))
    return O

def solve_aba27056(I):
    x1 = objects(I, T, F, T)
    x2 = mapply(toindices, cast_ContainerContainer(x1))
    x3 = box(cast_Patch(x2))
    x4 = difference(x3, x2)
    x5 = delta(cast_Indices(x2))
    x6 = position(x5, cast_Patch(x4))
    x7 = interval(ZERO, NINE, ONE)
...
def solve_f1cefba8(I):
    ...
    x27 = combine(cast_Container(x25), cast_Container(x26))
    x28 = intersection(x3, x27)
    x29 = fill(I, x14, cast_Patch(x27))
    O = fill(x29, x12, cast_Patch(x28))
    return O
...
def solve_1e32b0e9(I):
    ...
    x24 = apply(x23, x21)
    x25 = apply(x23, x22)
    x26 = papply(add, cast_Tuple(x24), cast_Tuple(x21))
...
def solve_28e73c20(I):
    ...
    x10 = insert(x2, x9)
    x11 = insert(x3, x10)
    x12 = fill(x7, ZERO, cast_Patch(x11))
    x13 = vupscale(x6, FIVE)
    x14 = hupscale(x13, THREE)
    x15 = insert(x4, x9)
    x16 = insert(x5, x15)
    x17 = fill(x14, ZERO, cast_Patch(x16))
    x18 = even(x1)
...
def solve_6d0160f0(I):
    ...
    x17 = product(cast_Container(x16), cast_Container(x16))
...
def solve_f8a8fe49(I):
    ...
    x9 = subgrid(x8, I)
    x10 = trim(x9)
    x11 = cast_Callable(x7)(x10)
    x12 = cast_Callable(x6)(x11, TWO)
    ...
    x23 = cast_Callable(x21)(x15)
    x24 = double(x23)
    x25 = compose(x22, increment)
    x26 = cast_Callable(x25)(x23)
    x27 = invert(x26)
    x28 = cast_Callable(x25)(x24)
    x29 = shift(x19, x27)
    x30 = shift(x20, x28)
    x31 = paint(x2, x29)
    O = paint(x31, x30)
...
def solve_d07ae81c(I):
    x1 = objects(I, T, F, F)
    x2 = sizefilter(x1, ONE)
    x3 = apply(color, cast_Container(x2))
    x4 = difference(x1, x2)
    x5 = apply(color, cast_Container(x4))
    x6 = first(x5)
    x7 = last(x5)
    x8 = ofcolor(I, x6)
    x9 = ofcolor(I, x7)
    ...
    x31 = fill(I, x29, cast_Patch(x19))
    O = fill(x31, x30, cast_Patch(x20))
    return O
...
def solve_0e206a2e(I):
    ...
    x22 = astuple(cast_Integer(cmirror), cast_Integer(dmirror))
    x23 = astuple(cast_Integer(hmirror), cast_Integer(vmirror))
    x24 = combine(cast_Container(x22), cast_Container(x23))
    x25 = product(x24, x24)
    x26 = fork(compose, first, last)
    x27 = apply(x26, cast_Container(x25))
    x28 = totuple(x27)
    x29 = combine(x24, x28)
...
def solve_d22278a0(I):
    ...
    x34 = mapply(x33, cast_ContainerContainer(x2))
    O = paint(I, cast_Object(x34))
    return O
...
def solve_4290ef0e(I):
    ...
    x27 = pair(x26, x26)
    x28 = mpapply(shift, cast_Tuple(x25), cast_Tuple(x27))
    x29 = astuple(x24, x24)
    x30 = canvas(x1, x29)
    x31 = paint(x30, cast_Object(x28))
    x32 = rot90(x31)
    x33 = paint(x32, cast_Object(x28))
    x34 = rot90(x33)
    x35 = paint(x34, cast_Object(x28))
    x36 = rot90(x35)
    O = paint(x36, cast_Object(x28))
    return O
...
def solve_50846271(I):
    ...
    x5 = fork(either, vline, hline)
    x6 = fork(both, x4, x5)
    x7 = mfilter(cast_Container(x2), x6)
    x8 = fill(I, TWO, cast_Patch(x7))
    x9 = objects(x8, T, F, F)
...
def solve_b527c5c6(I):
    ...
    x19 = mapply(x18, cast_ContainerContainer(x1))
    x20 = fill(I, TWO, cast_Patch(x19))
    ...
    x39 = combine(cast_Container(x37), cast_Container(x38))
...
def solve_b7249182(I):
    ...
    x13 = cast_Callable(x12)(x8)
    x14 = cast_Callable(x12)(x9)
    x15 = connect(x13, x14)
    ...
    x21 = initset(x16)
    x22 = insert(x20, x21)
    x23 = toobject(cast_Patch(x22), x19)
    x24 = astuple(ZERO, NEG_TWO)
    x25 = shift(x23, ZERO_BY_TWO)
    x26 = shift(x23, x24)
    x27 = combine(x25, x26)
    x28 = ulcorner(cast_Patch(x27))
    x29 = urcorner(cast_Patch(x27))
    x30 = connect(x28, x29)
    x31 = shift(x30, UP)
    x32 = llcorner(cast_Patch(x27))
    x33 = lrcorner(cast_Patch(x27))
    x34 = connect(x32, x33)
    x35 = shift(x34, DOWN)
    x36 = paint(x19, cast_Object(x27))
    x37 = fill(x36, x10, x31)
    x38 = fill(x37, x11, x35)
    x39 = cover(x38, cast_Patch(x22))
    O = cast_Callable(x4)(x39)
    return O
...
def solve_9d9215db(I):
    ...
    x7 = insert(x2, x6)
    x8 = insert(x3, x7)
    x9 = argmax(cast_Container(x8), x5)
    x10 = vmirror(x9)
    x11 = papply(pair, x9, cast_Tuple(x10))
    x12 = lbind(apply, maximum)
    x13 = apply(x12, x11)
    x14 = partition(cast_Grid(x13))
    x15 = sizefilter(x14, FOUR)
    x16 = apply(llcorner, cast_Container(x15))
    x17 = apply(lrcorner, cast_Container(x15))
    x18 = combine(x16, x17)
    x19 = cover(cast_Grid(x13), cast_Patch(x18))
    x20 = tojvec(NEG_TWO)
    ...
    x34 = rot180(x32)
    x35 = rot270(x32)
    x36 = papply(pair, cast_Tuple(x32), cast_Tuple(x33))
    x37 = apply(x12, x36)
    x38 = papply(pair, cast_Tuple(x37), cast_Tuple(x34))
    x39 = apply(x12, x38)
    x40 = papply(pair, cast_Tuple(x39), cast_Tuple(x35))
    O = cast_Grid(apply(x12, x40))
    return O
...
def solve_6855a6e4(I):
    ...
    x34 = shift(x23, x32)
    x35 = shift(x25, x33)
    x36 = merge(cast_ContainerContainer(x8))
    x37 = cover(x6, cast_Patch(x36))
    x38 = paint(x37, x34)
    x39 = paint(x38, x35)
    x40 = rot270(x39)
    O = branch(x5, x39, x40)
...
def solve_264363fd(I):
    ...
    x6 = equality(x4, FIVE)
    x7 = equality(x5, FIVE)
    x8 = astuple(cast_Integer(x6), cast_Integer(x7))
    x9 = add(UNITY, x8)
    x10 = invert(x9)
    x11 = center(x2)
    x12 = index(I, x11)
    ...
    x14 = add(x13, x11)
    x15 = index(I, x14)
    x16 = astuple(x12, cast_Integer(ORIGIN))
    x17 = initset(x16)
    x18 = cover(I, x2)
    x19 = mostcolor(x18)
    x20 = ofcolor(x18, x19)
    x21 = occurrences(x18, cast_Object(x17))
    ...
    x38 = mapply(x37, cast_ContainerContainer(x22))
...
def solve_7df24a62(I):
    ...
    x28 = astuple(cast_Integer(x6), cast_Integer(x7))
    x29 = astuple(cast_Integer(x8), cast_Integer(x9))
    x30 = combine(cast_Container(x28), cast_Container(x29))
    x31 = apply(x15, x30)
    ...
    x37 = apply(x26, x34)
    x38 = apply(x36, x33)
    x39 = papply(compose, cast_Tuple(x38), cast_Tuple(x37))
    x40 = lbind(compose, x10)
    x41 = apply(x40, x39)
    x42 = papply(sfilter, cast_Tuple(x35), cast_Tuple(x41))
    x43 = apply(x27, x30)
    x44 = mpapply(mapply, cast_Tuple(x43), x42)
    O = fill(I, ONE, cast_Patch(x44))
    return O
...
def solve_f15e1fac(I):
    ...
    x20 = insert(ZERO, x19)
    x21 = insert(x18, x19)
    x22 = apply(decrement, cast_Container(x21))
    x23 = order(cast_Container(x20), identity)
    ...
    x40 = apply(x39, x29)
    x41 = papply(shift, cast_Tuple(x40), cast_Tuple(x28))
    x42 = merge(cast_ContainerContainer(x41))
    x43 = fill(x13, EIGHT, cast_Patch(x42))
    x44 = chain(x3, x7, x12)
    O = cast_Callable(x44)(x43)
    return O
...
def solve_234bbc79(I):
    ...
    x22 = astuple(ZERO, cast_Integer(DOWN_LEFT))
    x23 = initset(x22)
    x24 = lbind(add, RIGHT)
    ...
    x34 = size(x1)
    x35 = power(x33, x34)
    x36 = astuple(cast_Integer(x23), cast_Integer(x6))
    x37 = cast_Callable(x35)(x36)
    x38 = first(x37)
    x39 = width(x38)
    x40 = decrement(x39)
...
def solve_22233c11(I):
    ...
    x11 = mapply(x10, cast_ContainerContainer(x1))
    O = fill(I, EIGHT, cast_Patch(x11))
    return O
...
def solve_2dd70a9a(I):
    ...
    x7 = cast_Callable(x6)(x1)
    x8 = cast_Callable(x6)(x2)
    x9 = greater(x7, x8)
    x10 = both(x4, x9)
    x11 = branch(x10, lowermost, uppermost)
    x12 = cast_Callable(x11)(x2)
    x13 = branch(x4, leftmost, rightmost)
    x14 = cast_Callable(x13)(x2)
    x15 = astuple(x12, x14)
    x16 = other(x2, x15)
    ...
    x25 = merge(cast_ContainerContainer(x24))
    x26 = cover(x19, cast_Patch(x25))
    x27 = shoot(x5, DOWN)
    x28 = shoot(x5, UP)
    x29 = shoot(x5, LEFT)
    x30 = shoot(x5, RIGHT)
    ...
    x38 = argmax(x34, x37)
    x39 = initset(x38)
    x40 = gravitate(cast_Patch(x39), x33)
    x41 = crement(x40)
    x42 = add(x38, x41)
    x43 = connect(x38, x42)
...
def solve_a64e4611(I):
    ...
    x23 = astuple(cast_Integer(x22), cast_Integer(I))
    x24 = cast_Callable(x20)(x23)
    x25 = fill(I, THREE, x24)
    x26 = interval(THREE, TEN, ONE)
    x27 = astuple(cast_Integer(x26), cast_Integer(x25))
    x28 = cast_Callable(x20)(x27)
    x29 = fill(x25, THREE, x28)
    x30 = astuple(cast_Integer(x26), cast_Integer(x29))
    x31 = cast_Callable(x20)(x30)
    ...
    x37 = sfilter(x1, x36)
    x38 = fill(I, THREE, cast_Patch(x37))
    ...
    x47 = sfilter(x39, x46)
    O = fill(x38, THREE, cast_Patch(x47))
    return O
...
def solve_7837ac64(I):
    ...
    x3 = remove(x2, x1)
    x4 = merge(cast_ContainerContainer(x3))
    x5 = subgrid(cast_Patch(x4), I)
    x6 = chain(color, merge, frontiers)
    x7 = cast_Callable(x6)(I)
    x8 = objects(x5, T, F, F)
...
def solve_a8c38be5(I):
    ...
    x16 = inbox(x7)
    x17 = sfilter(x16, x11)
    x18 = combine(cast_Container(x15), x17)
    x19 = fill(x5, ONE, cast_Patch(x18))
...
def solve_b775ac94(I):
    ...
    x26 = cast_Callable(x25)(x21)
    x27 = cast_Callable(x25)(x22)
    x28 = cast_Callable(x25)(x24)
    x29 = compose(crement, invert)
    x30 = lbind(compose, x29)
    x31 = cast_Callable(x30)(x16)
    x32 = cast_Callable(x30)(x17)
    x33 = cast_Callable(x30)(x15)
    x34 = fork(shift, x26, x31)
    x35 = fork(shift, x27, x32)
    x36 = fork(shift, x28, x33)
    x37 = lbind(index, I)
    x38 = lbind(compose, toindices)
    x39 = cast_Callable(x38)(x14)
    x40 = cast_Callable(x38)(x34)
    x41 = cast_Callable(x38)(x35)
    x42 = cast_Callable(x38)(x36)
    ...
    x52 = mapply(x49, cast_ContainerContainer(x1))
    x53 = mapply(x50, cast_ContainerContainer(x1))
    x54 = mapply(x51, cast_ContainerContainer(x1))
    x55 = paint(I, cast_Object(x52))
    x56 = paint(x55, cast_Object(x53))
    O = paint(x56, cast_Object(x54))
    return O
...
def solve_97a05b5b(I):
    ...
    x39 = astuple(cast_Integer(cmirror), cast_Integer(dmirror))
    x40 = astuple(cast_Integer(hmirror), cast_Integer(vmirror))
    x41 = combine(cast_Container(x39), cast_Container(x40))
    x42 = product(x41, x41)
    x43 = fork(compose, first, last)
    x44 = apply(x43, cast_Container(x42))
